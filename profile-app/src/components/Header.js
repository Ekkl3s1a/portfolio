...
const Header = () => {
  return (
    <motion.header
      ...
      className="place-self-stretch py-8 sm:py-10 lg:py-12 text-center bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600 p-6 rounded-xl shadow-lg hover:animate-gradient hover:shadow-2xl"
    >
